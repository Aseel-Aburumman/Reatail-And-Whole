                ...
                <form action="<?php echo e(route('admin.order.update', $Order->id)); ?>" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" class="form-control" id="deadline" name="deadline"
                            value="<?php echo e($Order->deadline); ?>" required>
                    </div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Reatail-And-Whole\resources\views/admin/order/edit.blade.php ENDPATH**/ ?>